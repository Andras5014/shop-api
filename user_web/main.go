...
func main() {
	...
	zap.S().Info("user_web启动成功，端口：", global.ServerConfig.Port)
...
//	func Register(name, id, address string, port int, tags []string) error {
...
//			HTTP:                           "http//127.0.01:8021/health",
//			Timeout:                        "5s",
//			Interval:                       "5s",
...
//	}
//
//	client.Agent().ServicesWithFilter("Service == 'user_web'")
//
//}
